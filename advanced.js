(function () {
  ...
  const THAI_LABEL = {
    ...
    "Asset QoQ% Diff": "ส่วนต่างสินทรัพย์ QoQ (%)",
    "Liabilities QoQ% Diff": "ส่วนต่างหนี้สิน QoQ (%)",
    "Equity QoQ% Diff": "ส่วนต่างส่วนผู้ถือหุ้น QoQ (%)",
